                      ...
                      <Container maxWidth="sm">
                        ...
                        <TabPanel value={value} index={0}>
                          ...
                          <p className="font-size-lg mb-5 text-black-50">
                            Fill in the fields below and you will be good to go.
                          </p>
                          <div className="mb-3">
                            <TextField
                              variant="outlined"
                          ...
                          <div className="form-group pt-2 mb-4">
                            By clicking the <strong>Create account</strong> button below you agree
                        ...
                        <TabPanel value={value} index={1}>
                          ...
                          <p className="font-size-lg mb-5 text-black-50">
                            You already have an account? Fill in the fields below to login into your
                            existing dashboard.
                          </p>
